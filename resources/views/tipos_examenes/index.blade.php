            ...
            <div class="card-body">
                <form action="{{ route('tipos.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control" placeholder="Ej: Biopsia Gástrica, Citología" required>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="2" class="text-center text-muted py-3">No hay tipos de examen configurados.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
