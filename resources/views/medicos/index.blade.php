                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-outline-primary me-1 fw-bold"
                                                    data-bs-toggle="modal" data-bs-target="#modalEditar{{ $medico->id }}">
                                                    Editar
                                                </button>
                                                ...
                                                <form action="{{ route('medicos.destroy', $medico->id) }}" method="POST"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="btn btn-sm btn-outline-danger fw-bold">Eliminar</button>
                                                </form>
                                            </td>
                                        </tr>

                                        <!-- MODAL DE EDICIÓN -->
                                        <div class="modal fade" id="modalEditar{{ $medico->id }}" tabindex="-1"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow">
                                                    <form action="{{ route('medicos.update', $medico->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-header bg-light">
                                                            <h5 class="modal-title fs-6 fw-bold text-primary">Editar
                                                                Registro de Médico</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body text-start">
                                                            <div class="mb-3">
                                                                <label class="form-label text-muted small fw-bold">NOMBRE Y
                                                                    APELLIDO</label>
                                                        ...
                                                        <div class="modal-footer bg-light">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary btn-sm fw-bold">Actualizar</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
