            ...
            <div class="card-body bg-white">
                <form action="{{ route('examenes.store') }}" method="POST" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="paciente_rut" name="paciente_rut" class="form-control" maxlength="12" required
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle text-center mb-0">
                        <thead>
                            ...
                            <!-- Fila de Slots -->
                            <tr class="bg-light">
                                <th class="p-2"><input type="text" name="correlativo"
                                        value="{{ request('correlativo') }}" class="form-control form-control-sm"></th>
                                <th class="p-2"><input type="date" name="fecha_toma"
                                        value="{{ request('fecha_toma') }}" class="form-control form-control-sm"></th>
                                <th class="p-2"><input type="text" name="paciente" value="{{ request('paciente') }}"
                                        class="form-control form-control-sm"></th>
                                <th class="p-2"><input type="text" id="filtro_rut" name="rut"
                                        value="{{ request('rut') }}" class="form-control form-control-sm"
                                        placeholder="RUT"></th>
                                ...
                                <th class="p-2">
                                    <select name="estado" class="form-select form-select-sm">
                                        ...
                                        <option value="EN ESPERA INFORME COMPLEMENTARIO"
                                            {{ request('estado') == 'EN ESPERA INFORME COMPLEMENTARIO' ? 'selected' : '' }}>
                                            EN ESPERA</option>
                                        <option value="INFORMADO RESULTADO CRÍTICO"
                                            {{ request('estado') == 'INFORMADO RESULTADO CRÍTICO' ? 'selected' : '' }}>
                                            CRÍTICO</option>
                                        <option value="INFORMADO"
                                            {{ request('estado') == 'INFORMADO' ? 'selected' : '' }}>INFORMADO</option>
                                    </select>
                                </th>
                                <th class="p-2"><button type="submit"
                                        class="btn btn-sm btn-primary w-100">Filtrar</button></th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($ex->estado == 'EN ESPERA INFORME COMPLEMENTARIO')
                                            <span class="badge-estado estado-espera">EN ESPERA INFORME
                                                COMPLEMENTARIO</span>
                                    ...
                                    <td>
                                        <a href="{{ route('examenes.show', $ex->id) }}"
                                            class="btn btn-sm btn-outline-dark fw-bold px-3">ABRIR</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
