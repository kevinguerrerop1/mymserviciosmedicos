            ...
            <div class="card-body">
                <form action="{{ route('usuarios.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" required placeholder="Ej: Dr. Carlos Pérez">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" id="role_select" class="form-select" required onchange="toggleLaboratorio(this.value)">
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach($u->roles as $r)
                                        <span class="badge bg-{{ $r->name == 'admin' ? 'danger' : ($r->name == 'patologo' ? 'warning text-dark' : 'info') }}">
                                            {{ strtoupper($r->name) }}
                                        </span>
                                    @endforeach
                                </td>
